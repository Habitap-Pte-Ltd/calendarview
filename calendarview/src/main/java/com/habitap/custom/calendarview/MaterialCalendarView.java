...
import com.habitap.custom.calendarview.format.ArrayWeekDayFormatter;
import com.habitap.custom.calendarview.format.DayFormatter;
import com.habitap.custom.calendarview.format.MonthArrayTitleFormatter;
import com.habitap.custom.calendarview.format.TitleFormatter;
import com.habitap.custom.calendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
  ...
  /**
   * Set a {@linkplain com.habitap.custom.calendarview.format.WeekDayFormatter}
   * with the provided week day labels
   *
   * @param weekDayLabels Labels to use for the days of the week
   * @see com.habitap.custom.calendarview.format.ArrayWeekDayFormatter
   * @see #setWeekDayFormatter(com.habitap.custom.calendarview.format.WeekDayFormatter)
   */
  ...
  /**
   * Set a {@linkplain com.habitap.custom.calendarview.format.TitleFormatter}
   * using the provided month labels
   *
   * @param monthLabels month labels to use
   * @see com.habitap.custom.calendarview.format.MonthArrayTitleFormatter
   * @see #setTitleFormatter(com.habitap.custom.calendarview.format.TitleFormatter)
   */
