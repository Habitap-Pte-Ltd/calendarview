...
public class DynamicSettersActivity extends AppCompatActivity implements OnDateLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        widget.setOnTitleClickListener(view -> Toast.makeText(DynamicSettersActivity.this, R.string.today, Toast.LENGTH_SHORT).show());

        widget.setOnDateLongClickListener(this);

        findViewById(R.id.button_other_dates).setOnClickListener(view -> onOtherDatesClicked());
        ((CheckBox) findViewById(R.id.enable_save_current_position)).setOnCheckedChangeListener((compoundButton, b) -> onSaveCurrentPositionChecked(b));
        ((CheckBox) findViewById(R.id.show_week_days)).setOnCheckedChangeListener((compoundButton, b) -> onShowWeekDaysChecked(b));
        ((CheckBox) findViewById(R.id.check_text_appearance)).setOnCheckedChangeListener((compoundButton, b) -> onTextAppearanceChecked(b));
        ((CheckBox) findViewById(R.id.check_page_enabled)).setOnCheckedChangeListener((compoundButton, b) -> onPageEnabledChecked(b));
